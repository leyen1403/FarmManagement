...
public class UpdateLivestockValidator : AbstractValidator<UpdateLivestockDto>
{
    public UpdateLivestockValidator()
    {
        RuleFor(x => x.Id)
        .GreaterThan(0).WithMessage("ID vật nuôi không hợp lệ.");
